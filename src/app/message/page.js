...
const getUserDataUrl = "http://localhost:4000/api/user/getuser";
const createNewChatUrl = "http://localhost:4000/api/chat/createnewchat";
const getUserChatsUrl = "http://localhost:4000/api/chat/getuserchats";
const getUserGroupsUrl = "http://localhost:4000/api/groupchat/getusergroups"
const pushMessageInGroup = "http://localhost:4000/api/groupchat/pushmessageingroup"
const getChatByIdUrl = "http://localhost:4000/api/chat/getchatbyid";
const getGroupChatByIdUrl = "http://localhost:4000/api/groupchat/getgroupchatbyid";
const createGroupUrl = "http://localhost:4000/api/groupchat/creategroup";
